 ...
 * https://blog.csdn.net/lqfsharks/article/details/48861531
 */
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        //增加选中字体的颜色
        mSelectedTabTextColor = a.getColor(R.styleable.PagerSlidingTabStrip_pstsSelectedTabTextColor, mSelectedTabTextColor);
