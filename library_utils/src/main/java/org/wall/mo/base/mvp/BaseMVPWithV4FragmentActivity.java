 ...
 * 作者姓名 修改时间 版本号 描述
 */
public abstract class BaseMVPWithV4FragmentActivity<view extends BaseContract.BaseView,
        presenter extends BaseContract.BasePresenter> extends AbsWithV4FragmentActivity
