 ...
 * 作者姓名 修改时间 版本号 描述
 */
public abstract class BaseMVPLazyLoadEasyProFragment<presenter extends BaseContract.BasePresenter, B extends ViewDataBinding>
        extends LazyLoadEasyProFragment<B>
